...
import com.juanpaabloalvis.projector.application.ports.in.CreateUnitIntInPort;
...
public class UnitsController {
    ...
    private final CreateUnitIntInPort createUnitIntInPort;
    ...
    public @ResponseBody UnitResponseDto getUnit(@RequestBody UnitRequestDto unitRequestDto) {
        ...
        unit = createUnitIntInPort.createUnit(unit);
